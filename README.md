...
- WARNING: This fork uses USE_EXACT_ALARM permission that is required for Android 14. However Play Store requires a very strong use case of it's usage, otherwise the app will get declined.
